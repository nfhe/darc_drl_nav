# coding=utf-8
# tensorboard --logdir "/home/he/catkin_nav/src/turtlebot3_ddpg_collision_avoidance/weight/DCEERDDPG/2023-04-04" --port 6006
...
class Args:
	def __init__(self,env):
		...
		self.model_path = '/home/he/catkin_nav/src/turtlebot3_ddpg_collision_avoidance/weight/{}/'.format(self.policy) + self.current_time +'/2/'
		# self.model_path = '/home/he/catkin_nav/src/turtlebot3_ddpg_collision_avoidance/weight/{}/'.format(self.policy) + self.current_time +'/3/'
...
if __name__ == "__main__":
		########################################################
	# game_state= train_env.GameState()   # game_state has frame_step(action) function
	game_state= turtlebot3_env.GameState()   # game_state has frame_step(action) function
	...
	policy = TRAIN_DCEERDDPG.DCEERDDPG(**kwargs)
